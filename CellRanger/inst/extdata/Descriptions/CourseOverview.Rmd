...
<br>
[<img src="https://github.com/RockefellerUniversity/RU_Course_template/workflows/R-CMD-check-bioc/badge.svg">](https://github.com/RockefellerUniversity//actions?query=workflow%3AR-CMD-check-bioc)

**The course is tested and available on MacOS, Windows and Ubuntu Linux for `r R.Version()$version.string`**
<br>
[<img src="https://github.com/RockefellerUniversity/RU_Course_template/workflows/R-CMD-check/badge.svg">](https://github.com/RockefellerUniversity//actions?query=workflow%3AR-CMD-check)
