...
- [Course Home Page](http://rockefelleruniversity.github.io/CellRanger/)
...
* [Cell Ranger](https://rockefelleruniversity.github.io/CellRanger/)

Or can be downloaded as a zip archive from here.

* [Download zip](https://github.com/rockefelleruniversity/CellRanger/zipball/master)
...
- Why run Cell Ranger:
  * You want to integrate datasets, but they were processed by different versions of Cell Ranger
  * You want to change Cell Ranger parameters i.e. export BAMs, or force an expected cell number.
...
Cell Ranger also outputs files for visualization within the (10X Loupe browser software)[https://www.10xgenomics.com/support/software/loupe-browser/latest] - _cloupe.cloupe_.
...
As most people do not run CellRanger themselves this is important to check it matches expectation (often genomics cores will run it for you)
